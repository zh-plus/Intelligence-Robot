...
setRobotPose(sim, [2 3 -pi/2]);% Enable ROS interface for the simulator. The simulator
...
title(axesHandle, 'ReflectionGrid: Update 0');
...
while( distanceToGoal > goalRadius )
    ...
    if~mod(updateCounter,50)
        ...
        title(axesHandle, ['ReflectionGrid: Update ' num2str(updateCounter)]);
    end
...
title(axesHandle, 'ReflectionGrid: Final Map');
